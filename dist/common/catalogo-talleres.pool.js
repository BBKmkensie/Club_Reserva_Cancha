...
exports.CATALOGO_TALLERES_SEED = void 0;
exports.normalizarNombreTaller = normalizarNombreTaller;
function img(id) {
    return `https://images.unsplash.com/${id}?auto=format&fit=crop&w=800&q=80`;
}
exports.CATALOGO_TALLERES_SEED = [
    {
        tipo: 'Futbol',
        alias: ['Fútbol'],
        conProfesor: true,
        descripcion: 'Taller de fútbol formativo: técnica con balón, juego en espacios reducidos y trabajo físico. ' +
    ...
    },
    {
        ...
        conProfesor: true,
        descripcion: 'Taller de voleibol: fundamentos de saque, recepción, armado y remate. ' +
    ...
    },
    {
        ...
        conProfesor: false,
        descripcion: 'Taller de básquetbol: manejo de balón, pases, tiros y juego posicional. ' +
    ...
    },
    {
        tipo: 'Folclore',
        conProfesor: false,
        descripcion: 'Taller de danza y música folclórica chilena. Aprende cuecas, tonadas y expresión corporal ' +
    ...
    },
    {
        tipo: 'Rodeo',
        conProfesor: false,
        descripcion: 'Introducción al rodeo escolar y a la chilenidad: conocimiento del caballo, aseo equino ' +
    ...
    },
    {
        tipo: 'Emprendimiento',
        conProfesor: false,
        descripcion: 'Desarrolla ideas de negocio, pitch, marketing básico y finanzas personales. ' +
    ...
    },
    {
        ...
        alias: ['Construcción'],
        conProfesor: false,
        descripcion: 'Taller práctico de oficios: lectura de planos simples, uso seguro de herramientas ' +
    ...
    },
    {
        ...
        descripcion: 'Expresión dramática, improvisación y montaje escénico. Trabajo de voz, corporalidad ' +
    ...
    },
    {
        tipo: 'Lectura',
        conProfesor: false,
        descripcion: 'Club de lectura: comprensión lectora, análisis de textos y hábito de lectura ' +
    ...
    },
    {
        ...
        descripcion: 'Juegos de mesa, lógica y resolución de problemas en un ambiente lúdico. ' +
    ...
    },
    {
        ...
        alias: ['Robótica'],
        conProfesor: false,
        descripcion: 'Programación y armado de robots educativos. Introducción a sensores, motores ' +
    ...
    },
    {
        ...
        descripcion: 'Iniciación musical: ritmo, canto, lectura básica y ensamble con instrumentos. ' +
    ...
    },
    {
        ...
        descripcion: 'Diseño gráfico digital: composición, color, tipografía y proyectos con herramientas ' +
    ...
    },
    {
        tipo: 'Tejido',
        conProfesor: false,
        descripcion: 'Técnicas de tejido y crochet: puntos básicos, lectura de patrones y confección ' +
    ...
    },
    {
        ...
        descripcion: 'Grupo de reflexión y servicio con enfoque cristiano: valores, voluntariado escolar ' +
    ...
    },
    {
        ...
        alias: ['Videojuegos'],
        conProfesor: false,
        descripcion: 'Diseño y análisis de videojuegos: mecánicas, narrativa, balance y prototipado ' +
    ...
    },
    {
        tipo: 'Huerta',
        conProfesor: false,
        descripcion: 'Agricultura urbana escolar: siembra, compost, riego y cosecha. Conecta ciencias ' +
    ...
    },
    {
        tipo: 'Tenis de mesa',
        conProfesor: false,
        descripcion: 'Técnica de drive, revés, servicio y juego de dobles. Mejora reflejos, concentración ' +
    ...
    },
    {
        ...
        descripcion: 'Entrenamiento de fuerza con técnica segura: calentamiento, máquinas, peso libre ' +
    ...
    },
    {
        ...
        descripcion: 'Artes marciales y defensa personal: coordinación, disciplina, autocontrol ' +
            'y técnicas de protección en situaciones de riesgo.',
        imagenUrl: img('photo-1555597673-b21d5c935865'),
    },
];
function normalizarNombreTaller(nombre) {
    return nombre
        .normalize('NFD')
        .replace(/\p{M}/gu, '')
        .toLowerCase()
...
//# sourceMappingURL=catalogo-talleres.pool.js.map